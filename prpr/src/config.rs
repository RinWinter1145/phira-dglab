...
pub struct Config {
    ...
    pub mp_enabled: bool,
    pub dglab_enabled: bool,
    pub dglab_use_ble: bool,
    pub dglab_ws_url: String,
    pub dglab_listen_port: u16,
    pub dglab_perfect_power: String,
    pub dglab_good_power: String,
    pub dglab_badmiss_power: String,
    pub note_scale: f32,
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            dglab_enabled: false,
            dglab_use_ble: false,
            dglab_ws_url: String::new(),
            dglab_listen_port: 9999,
            dglab_perfect_power: String::new(),
            dglab_good_power: String::new(),
            dglab_badmiss_power: String::new(),
            note_scale: 1.0,
            offline_mode: false,
